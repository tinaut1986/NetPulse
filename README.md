...
- **UI:** 100% Jetpack Compose for a reactive and fluid experience.
- **Concurrency:** Kotlin Coroutines & Flow for performant, non-blocking network operations.
- **Architecture:** MVVM (Model-View-ViewModel) pattern for clean and maintainable code.
- **Networking:** Native Android Sockets and InetAddress for low-level control.

## 📦 Installation

*(Update once published or provided as APK)*
